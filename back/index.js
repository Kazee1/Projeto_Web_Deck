...
app.post('/CallCthulhu', async (req,res) => {
    ...
    const id = fichas.length + 1;
    const ficha = {"id": id,"tipo": "CallCthulhu","NomeJogador":NomeJogador,
